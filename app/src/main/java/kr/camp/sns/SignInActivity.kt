...
class SignInActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.loginButton.setOnClickListener {
            ...
            // intent로 id 값 전달
            // binding함수 작성
            val idEmpty = binding.idEditText.text.isEmpty()
            val passwordEmpty = binding.passwordEditText.text.isEmpty()
            ...
            } else if(idEmpty || passwordEmpty) {
                Toast.makeText(this, "공란이 존재합니다", Toast.LENGTH_LONG).show()
            } else {
